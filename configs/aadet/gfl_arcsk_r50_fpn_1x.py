...
model = dict(
    type='RGFL',
    pretrained='/home/oneco/xyh/rotate_detection/checkpoints/ARC_ResNet50_xFFF_n4.pth',
    backbone=dict(
        type='ARCSKResNet',
        replace=[
            ['x'],
    ...
    train_cfg=dict(
        assigner=dict(type='RATSSAssigner', topk=9, iou_calculator=dict(type='RBboxOverlaps2D', version=angle_version)),
        allowed_border=-1,
        pos_weight=-1,
        debug=False),
    test_cfg=dict(
...
# 记得改
work_dir = '/data/Aerial/checkpoints/rgfl/left_3_right2_reg_11'

# mAP: 0.7465713539796209
# ap of each class: plane:0.8845288368710759, baseball-diamond:0.7884656683312234, bridge:0.5181782436464554, ground-track-field:0.7149785590096636, small-vehicle:0.8108874872987584, large-vehicle:0.8010169113165756, ship:0.8776810496403602, tennis-court:0.9090231675924673, basketball-court:0.8513346135687098, storage-tank:0.8421322838964069, soccer-ball-field:0.5720087742087351, roundabout:0.6522798542660925, harbor:0.6579353759013207, swimming-pool:0.6930008373201424, helicopter:0.6251186468263289
# COCO style result:
#
# AP50: 0.7465713539796209
# AP75: 0.4530688942820635
# mAP: 0.4399448959142657
# The submitted information is :
#
# Description: /data/Aerial/checkpoints/rgfl/left_3_right2_reg_11
